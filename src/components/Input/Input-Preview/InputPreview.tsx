    ...
    <div style={inputContainerStyles} className="flex flex-col">
      ...
      >
        ...
        <input
          ...
          className={`input-preview-element w-full outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-all duration-150 ease-in-out ${inputCustomClass}`}
